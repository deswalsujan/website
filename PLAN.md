...
- **Body font changed from Geist to Zalando Sans (24 Sept 2026).** Instrument Sans and Zalando Sans were both trialled against Geist on a local test branch; Zalando Sans was picked. Loaded from Google Fonts as a variable font covering weights 400 to 700. Geist Mono stays for code.
